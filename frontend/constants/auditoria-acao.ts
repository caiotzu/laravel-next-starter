...
export const AUDITORIA_ACAO_BADGE:
  Record<AuditoriaAcao, string> = {
    cadastro: "bg-emerald-100 text-emerald-700 dark:bg-emerald-950 dark:text-emerald-400",
    atualizacao: "bg-blue-100 text-blue-700 dark:bg-blue-950 dark:text-blue-400",
    exclusao: "bg-red-100 text-red-700 dark:bg-red-950 dark:text-red-400",
    restauracao: "bg-amber-100 text-amber-700 dark:bg-amber-950 dark:text-amber-400",
  };
