...
import { Release } from "@/domains/private/release/types/release.model";
        ...
        {releases.map((release) => {
          ...
          return (
            ...
            >
              ...
              <span
                aria-hidden
                className={`pointer-events-none absolute inset-y-0 left-0 w-[3px] origin-left scale-y-0 opacity-0 transition-all duration-200 ease-out group-hover:scale-y-100 group-hover:opacity-100 ${getReleaseTipoBadge(
                  release.tipo
                )}`}
              ...
              {/* Ícone */}
              <div
                className={`flex size-9 shrink-0 items-center justify-center rounded-lg ${getReleaseTipoBadge(
                  release.tipo
                )}`}
              >
              ...
              <div className="min-w-0 flex-1">
                ...
                <div className="mb-1 flex items-center gap-2">
                  <Badge
                    className={`font-normal ${getReleaseTipoBadge(
                      release.tipo
                    )}`}
                  >
