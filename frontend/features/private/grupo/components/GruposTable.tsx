...
import { ativarGrupo, excluirGrupo } from "@/domains/private/grupo/services/grupoService";
              ...
              <TableCell className="text-right">
                <DropdownMenu>
                  ...
                  <DropdownMenuContent align="end">
                    {/* Visualizar */}
                    <PrivatePermissionGuard permission="private.grupo.visualizar" disableFallback={true}>
                      <DropdownMenuItem asChild>
                        <Link
                          href={`/grupos/${grupo.id}/visualizar`}
                    ...
                    {/* Ativar */}
                    {grupo.deletedAt && (
                      <PrivatePermissionGuard permission="private.grupo.ativar" disableFallback={true}>
                        <DropdownMenuItem
                    ...
                    {/* Excluir */}
                    {!grupo.deletedAt && (
                      <PrivatePermissionGuard permission="private.grupo.excluir" disableFallback={true}>
                        <DropdownMenuItem
