...
import { atualizarEmpresaContato, cadastrarEmpresaContato, excluirEmpresaContato } from "@/domains/private/empresa-contato/services/empresaContatoService";
import { EmpresaContato } from "@/domains/private/empresa-contato/types/empresaContato.model";
                    ...
                    <TableCell className="text-right">
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end">
                          <PrivatePermissionGuard
                            permission="private.empresa.contato.atualizar"
                            disableFallback={true}
                          >
                            <DropdownMenuItem
                              onClick={() => onEdit(item)}
                          ...
                          <PrivatePermissionGuard
                            permission="private.empresa.contato.excluir"
                            disableFallback={true}
                          >
                            <DropdownMenuItem
