...
import { CaixaMensagem } from "@/domains/admin/mensagem/types/caixaMensagem.model";
import { formatDate } from "@/lib/utils";

interface Props {
  mensagem: CaixaMensagem;
  onMarcarComoLida: (mensagemId: string) => void;
  isMarcandoComoLida?: boolean;
}

export function CaixaMensagemItem({ mensagem, onMarcarComoLida, isMarcandoComoLida = false }: Props) {
  return (
    <div
