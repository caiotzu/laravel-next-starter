...
import { useEmpresa } from "@/domains/private/empresa/hooks/useEmpresa";

import { EmpresaFormEditSkeleton } from "@/features/private/empresa/components/EmpresaFormEditSkeleton";
import { EmpresaFormView } from "@/features/private/empresa/components/EmpresaFormView";
			...
			<SidebarInset>
				...
				<div className="flex flex-1 flex-col">
					<div className="flex flex-col gap-6 py-6 px-4 lg:px-6">
						...
						<PrivatePermissionGuard permission="private.empresa.visualizar" >
							{isLoading || !data ? (
