...
use App\Http\Resources\Private\Auth\MeResource;
use App\Http\Resources\Private\Auth\LoginResource;
use App\Http\Resources\Private\Auth\LogoutResource;
use App\Http\Resources\Private\Auth\RefreshResource;
use App\Http\Resources\Private\Auth\EsqueceuSenhaResource;
use App\Http\Resources\Private\Auth\LoginGoogle2FaEnableResource;
use App\Http\Resources\Private\Auth\RedefinirSenhaValidarResource;
use App\Http\Resources\Private\Auth\PrimeiroAcessoValidarResource;
...
class AuthController extends Controller
{
    ...
    public function verificar2fa(Verificar2faRequest $request): JsonResponse
    {
        ...
        try {
            ...
            $usuario = $this->usuarioService->obterUsuarioAtivoPorId($userId, EntidadeTipo::PRIVATE);
